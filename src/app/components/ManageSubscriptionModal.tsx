        ...
        {tab === 'overview' && (
          ...
          <div className={`pt-8 grid ${paymentFailed && !isAU && !isVp ? 'grid-cols-[1fr_360px] gap-8' : 'grid-cols-1 gap-4'} items-stretch`}>
            ...
            {!isAU && !isVp && !paymentFailed && !cancelled ? (
              ...
              <>
                {/* Status card — matches RG: name + pill + stroke CTA, price + date row */}
                <div className="rounded-xl bg-white overflow-hidden" style={{ border: '1px solid #E6E8EC' }}>
                  <div className="px-6 py-6">
                    ...
                    <p className="mt-3" style={{ fontSize: 13.5, color: '#6B7280', lineHeight: 1.55 }}>
                      <span style={{ color: '#1C1E21', fontWeight: 600 }}>$399</span> USD / month <span style={{ color: '#D1D5DB' }}>·</span>{' '}
                      {isVp
                        ? <>Trial ended <span style={{ color: '#1C1E21', fontWeight: 500 }}>May 21, 2026</span></>
                        : <>Trial ends <span style={{ color: '#1C1E21', fontWeight: 500 }}>May 21, 2026</span> <span style={{ color: '#9CA3AF' }}>(in 31 days)</span></>}
                    </p>
                  </div>
                </div>
