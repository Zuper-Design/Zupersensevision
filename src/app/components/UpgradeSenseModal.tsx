  ...
  return (
    <>
            ...
            <div className="p-6">
              ...
              >
                ...
                <div className="flex items-center gap-3 relative z-10">
                  <span className="text-[44px] font-bold leading-none" style={{ background: 'linear-gradient(135deg, #FD5000 0%, #F97316 40%, #EC4899 100%)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent', backgroundClip: 'text' }}>$300</span>
      ...
      <CheckoutModal
        ...
        onSuccess={() => { setCheckoutOpen(false); setUpgraded(true); }}
      />
    </>
  );
}
